                ...
                success: function(res){
                    if(res.status == "success"){
                    	...
                    	$.each(typeData, function(i, n) {
							 ...
							 divBody += "<p class='card-text'>房東："+n.Name+"<br>電話："+n.Phone+"<br>預約時間："+n.RDate+"<br>房屋坪數："+n.Size+"<br>房屋租金："+n.Rent+"/月<br>房屋設備："+n.Equipment+"<br>屋齡:"+n.HYear+"<br>其他備註："+n.GenderSpecific+"</p>"
