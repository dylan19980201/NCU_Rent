      ...
      <nav class="nav-top bg-red p-2 d-md-flex align-items-center">
        ...
        <div>
          <ul class="nav-link d-flex justify-content-center list-unstyled pt-3">
            <li>
              <a class="text-white text-decoration-none d-flex pe-4" href="#"><i class="pe-1 mt-1 fas fa-search"></i><span class="nav-name d-none d-md-block">管理系統</span></a>
            </li>
            <li>
            ...
            <li>
              <a class="text-white text-decoration-none d-flex" href="#"><i class="pe-1 mt-1 fas fa-bars"></i><span class="nav-name d-none d-md-block">審查房東與房屋評價&nbsp</span></a>
            </li>
	    <li>
              <a class="text-white text-decoration-none d-flex" href="#"><i class="pe-1 mt-1 fas fa-bars"></i><span class="nav-name d-none d-md-block">審查學生評價</span></a>
            </li>
          </ul>
        </div>
      </nav>
