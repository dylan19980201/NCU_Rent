            ...
            <div class=".register-page">
                <div class="form">
                    ...
                    <form class="register-form" action="/NCURent/Login/Register" method="post">
                        ...
                        <input type="text" name="id" placeholder="帳號(請輸入3~12位英數字)" pattern="[0-9||A-z]{3,12}"
                            required="required" />
                        <input type="password" name="password" placeholder="密碼(請輸入3~16位英數字)" pattern="[0-9||A-z]{3,16}"
                            required="required" />
                        <input type="text" name="name" placeholder="姓名" required="required" />
                        <select class="form-select" name="gender" style="width:100%;height:40px; margin: 0 0 15px; ;"
                            required="required">
                        ...
                        <input type="text" name="phone" placeholder="手機號碼(請輸入09XXXXXXXX)" required="required"
                            pattern="09\d{8}" />
