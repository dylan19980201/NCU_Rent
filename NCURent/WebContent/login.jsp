<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <%@ page import="java.util.*" %>
        <% if (session.getAttribute("id")!=null){ String redirectURL="/NCURent/html/index.jsp" ;
                ...
                <div class="login-page">
                    <div class="form">
                        ...
                        <form class="login-form" action="/NCURent/Login/Login" method="post">
                            ...
                            <input type="text" placeholder="帳號(請輸入3~12位英數字)" pattern="[0-9||A-z]{3,12}" name="id"
                                pattern="[0-9A-z]{4,12}" />
                            <input type="password" placeholder="密碼(請輸入3~16位英數字)" pattern="[0-9||A-z]{3,16}"
                                name="password" />
